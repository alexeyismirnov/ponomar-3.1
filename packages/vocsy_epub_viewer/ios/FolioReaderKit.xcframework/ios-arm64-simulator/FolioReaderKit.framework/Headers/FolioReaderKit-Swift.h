...
#ifndef FOLIOREADERKIT_SWIFT_H
#define FOLIOREADERKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FolioReaderKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14FolioReaderKit9SMSegment")
...
SWIFT_CLASS("_TtC14FolioReaderKit13SMSegmentView")
